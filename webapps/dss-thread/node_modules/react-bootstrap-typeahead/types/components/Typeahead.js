...
class TypeaheadComponent extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Typeahead, { ...this.props, options: options, ref: instanceRef }, (props) => {
            ...
            return (React.createElement(RootClose, { disabled: open || !isMenuShown, onRootClose: hideMenu }, (ref) => (React.createElement("div", { className: cx('rbt', { 'has-aux': !!auxContent }, className), ref: ref, style: {
                    ...style,
                    outline: 'none',
                    position: 'relative',
                }, tabIndex: -1 },
    ...
    _renderInput = (inputProps, props) => {
        ...
        return (React.createElement(TypeaheadInputMulti, { ...commonProps, selected: selected }, selected.map((option, idx) => (renderToken || defaultRenderToken)(option, { ...commonProps, labelKey, onRemove }, idx))));
    };
