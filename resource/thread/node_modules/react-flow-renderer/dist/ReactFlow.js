...
function getSmoothStepPath(_ref) {
  ...
  if (leftAndRight.includes(sourcePosition) && leftAndRight.includes(targetPosition)) {
    ...
    } else if (sourcePosition === exports.Position.Right && targetPosition === exports.Position.Left || sourcePosition === exports.Position.Left && targetPosition === exports.Position.Right || sourcePosition === exports.Position.Left && targetPosition === exports.Position.Left) {
      // and sourceX > targetX
...
var Handle = /*#__PURE__*/React$1.forwardRef(function (_ref, ref) {
