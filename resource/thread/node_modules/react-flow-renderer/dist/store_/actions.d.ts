import { Node, Edge, Elements, OnConnectEndFunc, OnConnectFunc, OnConnectStartFunc, OnConnectStopFunc, NodeDimensionUpdate, NodeDiffUpdate, XYPosition, Transform, Dimensions, InitD3ZoomPayload, TranslateExtent, SetConnectionId, SnapGrid, ConnectionMode, OnElementsChange } from '../types';
...
export declare const setNodes: (nodes: Node[]) => {
    type: "SET_NODES";
    payload: Node<any>[];
};
export declare const setEdges: (edges: Edge[]) => {
    type: "SET_EDGES";
    payload: Edge<any>[];
};
