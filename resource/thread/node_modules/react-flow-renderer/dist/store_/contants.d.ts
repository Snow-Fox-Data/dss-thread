...
export declare const SET_EDGES = "SET_EDGES";
...
export declare const SET_ON_NODES_CHANGE = "SET_ON_NODES_CHANGE";
export declare const SET_ON_EDGES_CHANGE = "SET_ON_EDGES_CHANGE";
