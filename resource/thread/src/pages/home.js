...
class Home extends Component {
    ...
    collectionStats() {
        return <div style={{padding:'20px'}}>
            ...
            <h2><span style={{color:'red'}}>{this.state.collectionStats.project_ct.toLocaleString("en-US")}</span> Projects</h2>
            <h2><span style={{color:'red'}}>{this.state.collectionStats.dataset_ct.toLocaleString("en-US")}</span> Datasets</h2>
            <h2><span style={{color:'red'}}>{this.state.collectionStats.column_ct.toLocaleString("en-US")}</span> Columns</h2>
        </div>
    }
