            ...
            <Modal size="lg" show={this.state.applyLineageModal} animation={false} onHide={() => this.cancelLineageSave()}>
                ...
                <Modal.Body>
                    <Container>
                        ...
                        {this.props.item.lineage_upstream.map((type) => (!eval(this.props.item.definition.applied_to).includes(type) &&
                        ...
                        {this.props.item.lineage_downstream.map((type) => (!eval(this.props.item.definition.applied_to).includes(type) &&
